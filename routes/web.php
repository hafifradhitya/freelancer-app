...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:apply job')->group(function () {
        ...
        Route::get('/dashboard/proposal_details/{project}/{projectApplicant}', [DashboardController::class, 'proposal.details'])
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware('can:manage wallets')->group(function () {
            ...
            Route::get('/wallet/topups', [WalletController::class, 'wallet_topups'])
                ->name('topups');
